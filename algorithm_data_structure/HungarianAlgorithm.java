...
public class HungarianAlgorithm {
	  ...
	  public static void main(String[] args) {
		  ...
		  HungarianAlgorithm h = new HungarianAlgorithm(costs);
		  int[] ans = h.execute();
		  for (int i = 0; i < 3; i++) {
	  ...
	  protected void computeInitialFeasibleSolution() {
	    for (int j = 0; j < dim; j++) {
	      labelByJob[j] = (int)Double.POSITIVE_INFINITY;
	    }
	    for (int w = 0; w < dim; w++) {
	      for (int j = 0; j < dim; j++) {
	  ...
	  protected void executePhase() {
	    while (true) {
	      ...
	      int minSlackValue = (int)Double.POSITIVE_INFINITY;
	      for (int j = 0; j < dim; j++) {
	  ...
	  protected void reduce() {
	    ...
	    int[] min = new int[dim];
	    for (int j = 0; j < dim; j++) {
	      min[j] = (int)Double.POSITIVE_INFINITY;
	    }
	    for (int w = 0; w < dim; w++) {
	      for (int j = 0; j < dim; j++) {
